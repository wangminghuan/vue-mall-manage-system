...
<template>
  <div>
    <el-select v-model="selectProvince" placeholder="请选择省份" :style="{'width':width+'px'}" :disabled="disable">
    <el-option
    ...
    <el-select v-model="selectCity" placeholder="请选择城市" :style="{'width':width+'px'}" :disabled="disable">
    <el-option
    ...
    <el-select v-model="selectRegions" placeholder="请选择区域" :style="{'width':width+'px'}" :disabled="disable">
    <el-option
